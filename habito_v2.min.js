  ...
  mm.add("(min-width: 768px)", () => {
    $(".section.is-service").each(function () {
      ...
      gsap
        ...
        .fromTo(".service-item", { y: "100vh", stagger: 0.2 }, { y: "0", stagger: 0.2 });
    });
  });
  ...
  mm.add("(max-width: 767px)", () => {
    $(".section.is-service").each(function () {
      ...
      gsap
        ...
        .fromTo(".service-item", { y: "100svh" }, { y: "0" });
    });
  });
}
...
function initAboutAnimation() {
  ...
  tl.from("[about-reels]", { scale: 0, ease: "primary-ease-out", duration: 1.25 }, 0.6);
}
